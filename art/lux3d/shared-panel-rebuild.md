...
The v2 surfacing asset budget is 160,000 triangles and 5 MiB; legacy assets retain 100,000 triangles. The accepted GLB has 154,968 triangles / 65 primitives / 4,518,032 bytes. The 21-inch bead seat and visible rim flange are distinct measurements. Geometry and a local desktop performance measurement justify the explicit budget increase; this does not certify physical phones.
